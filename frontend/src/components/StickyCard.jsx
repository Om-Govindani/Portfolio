...
export default function StickyCard(){
    return(
        <div className=" lg:sticky lg:top-[55px] relative lg:h-160 lg:w-86 md:h-135 sm:h-115.25 w-full h-115.25 bg-white rounded-2xl overflow-hidden ease-in-out transition-all duration-300 lg:flex-none">
            ...
            <div className='w-full h-full flex flex-col items-center ease-in-out transition-all duration-300 py-7.5 px-5 gap-6'>
                ...
                <div className='w-full h-1/2 lg:h-1/2 md:h-2/5 px-5 pb-6 flex flex-col lg:justify-between'>
                    <h1 className='w-full h-18 font-bold font-sans text-neutral-900 text-[28px] md:text-[36px] lg:text-[36px] text-center'>Om Govindani</h1>
                    <div className='flex-col items-center'>
                        ...
                        <div className="flex justify-center gap-6 mt-5 text-orange-500/90">
                            <a href="https://github.com/om-govindani"><button className="hover:scale-110 transition" title='Github'><FaGithub size={28} /></button></a>
                            <a href="https://linkedin.com/om-govindani"><button className="hover:scale-110 transition" title='Linkedin'><FaLinkedin size={28} /></button></a>
                            <a href="https://leetcode.com/u/dichotomyofame/"><button className="hover:scale-110 transition" title="Leetcode"><SiLeetcode size={28} /></button></a>
                            <a href="https://codeforces.com/profile/omgovindani"><button className="hover:scale-110 transition" title="CodeForces"><SiCodeforces size={28} /></button></a>
                        </div>
                    </div>
                </div>
            </div>
