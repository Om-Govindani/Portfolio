...
export default function StickyCard(){
    return(
        <div className="relative lg:h-160 lg:w-86 md:w-195.25 md:h-135 sm:w-120 sm:h-115.25 w-120 h-115.25 bg-white rounded-2xl mx-auto overflow-hidden ease-in-out transition-all duration-300">
            ...
            <img src={joint1} alt="joint1" className='absolute lg:bottom-35 lg:-left-35 md:bottom-16 md:-left-32 sm:-left-50 sm:bottom-43 -left-50 bottom-43 w-67.5 h-41.5 ' />
            <div className='w-full h-full flex-col ease-in-out transition-all duration-300'>
                <div className='w-full h-1/2 lg:h-1/2 md:h-3/5 p-4 flex items-center'>
                    <img src={Photo} alt='photo' className='h-50 sm:h-50 md:h-70 mx-auto rounded-2xl ease-in-out transition-all duration-300'/>
                </div>
